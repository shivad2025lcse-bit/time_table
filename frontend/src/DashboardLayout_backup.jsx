...
export default function DashboardLayout() {
    ...
    useEffect(() => {
        ...
        const scripts = ["/js/theme.js", "/js/app.js", "/js/timetable.js", "/js/frontend_app.js?v=9", "/js/charts.js", "/js/reports.js", "/js/quiz.js?v=3"];
        scripts.forEach(src => {
                    ...
                    <div className="container-fluid px-4">
                        <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <div className="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <button id="manageClassTtBtn" className={`btn btn-sm btn-outline-primary align-items-center gap-1 ${isFaculty ? 'd-flex' : 'd-none'}`} type="button" data-bs-toggle="modal" data-bs-target="#manageClassTtModal" onClick={() => window.initManageClassTt && window.initManageClassTt()}>
